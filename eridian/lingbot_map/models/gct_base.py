...
from eridian.lingbot_map.heads.dpt_head import DPTHead
...
class GCTBase(nn.Module, PyTorchModelHubMixin, ABC):
    ...
    def _predict_camera(
        ...
        _dev = aggregated_tokens_list_fp32[0].device.type if aggregated_tokens_list_fp32 else 'cpu'
        with torch.amp.autocast(_dev, enabled=False):
